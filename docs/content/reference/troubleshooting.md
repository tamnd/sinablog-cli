...
Most of these come down to network reality or how sinablog serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sinablog rate-limits like any public site. sinablog already paces
...
Where a surface is gated, sinablog reads a cookie or token you supply
...
`sinablog`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sinablog actually did
