...
// HTTP behaviour is covered in sinablog_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "sinablog://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("sinablog", "about")
	if err != nil || got.String() != "sinablog://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want sinablog://page/about", got.String(), err)
	}
}
